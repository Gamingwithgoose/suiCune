...
// ScrollingMenu MenuData flags
enum {
    SCROLLINGMENU_CALL_FUNCTION1_CANCEL_F,
    SCROLLINGMENU_CALL_FUNCTION3_NO_SWITCH_F,
    SCROLLINGMENU_ENABLE_LEFT_F,
    SCROLLINGMENU_ENABLE_RIGHT_F,
    SCROLLINGMENU_DISPLAY_ARROWS_F,
    SCROLLINGMENU_ENABLE_FUNCTION3_F,
    SCROLLINGMENU_ENABLE_START_F,
    SCROLLINGMENU_ENABLE_SELECT_F,
};
...
enum {
    ...
    SCROLLINGMENU_NATIVE_ITEMS_NORMAL,
    SCROLLINGMENU_NATIVE_ITEMS_QUANTITY,
};
