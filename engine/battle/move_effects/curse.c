...
//  curse
    ...
    const uint8_t* types = (gBattle.turn == TURN_PLAYER)? gBattle.player.mon.types: gBattle.enemy.mon.types;
    uint8_t* statLevels = (gBattle.turn == TURN_PLAYER)? gBattle.player.statStages: gBattle.enemy.statStages;
